...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '10482b251d8b80c9a72cf0135fd8f323',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Momoe', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || `Let's embark on adorable adventures together!✨`, // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.momoe.0t0.jp', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || `MOMOE'S BLOG`, // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://bbs.mikocon.com/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'OPFU3OMRAB', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || 'e8d3093bc3d2b06c6f30d7dc8aa71d12', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || '4f2608913d4dfe8d855d0e2f3f452914', // 客户端搜索用的KEY
  ...
  MOUSE_FOLLOW_EFFECT_COLOR: '#2aecef', // 鼠标点击特效颜色 #xxxxxx 或者 rgba(r,g,b,a)
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.momoe.0t0.jp', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://.com/article/notionnext-twikoo
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || '', // 你的代码仓库名， 例如我是 '/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || '', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline..com @see https://waline.js.org/guide/get-started.html
  ...
  // ----> 站点统计
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // vercel自带的统计 https://vercel.com/docs/concepts/analytics/quickstart https://github.com//NotionNext/issues/897
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '', // id，在51la后台获取 参阅 https://docs..com/article/notion-next-51-la
  ...
  ANALYTICS_ACKEE_TRACKER:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_TRACKER || '', // e.g 'https://ackee..com/tracker.js'
  ANALYTICS_ACKEE_DATA_SERVER:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_DATA_SERVER || '', // e.g https://ackee..com , don't end with a slash
  ...
  ADSENSE_GOOGLE_TEST: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_TEST || false, // 谷歌广告ID测试模式，这种模式获取假的测试广告，用于开发 https://www..com/article/local-dev-google-adsense
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'GCP SERVERS', // 站点描述，被notion中的页面描述覆盖
